...
export default function Committees() {
  return (
    <main className="pt-40 pb-20 px-6 max-w-7xl mx-auto">
      {/* Hero Section */}
      <header className="mb-24 flex flex-col items-start gap-6">
        <motion.div 
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-8xl font-headline font-bold tracking-tighter text-on-surface leading-none"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        >
          <div className="glass-card liquid-border rounded-xl p-10 h-full flex flex-col justify-between hover:bg-surface-variant/40 transition-colors duration-500 overflow-hidden relative">
        ...
        >
          <div className="glass-card liquid-border rounded-xl p-10 h-full flex flex-col justify-between hover:bg-surface-variant/40 transition-colors duration-500">
            <div>
        ...
        <motion.div 
          ...
          className="md:col-span-8 group relative overflow-hidden rounded-xl bg-surface-container-low border border-outline-variant/20"
        >
          ...
          <img 
            ...
            referrerPolicy="no-referrer"
          />
          <div className="relative z-20 p-12 h-full flex flex-col justify-end max-w-xl">
            <div className="mb-4 inline-flex items-center gap-2 text-primary font-bold">
              <span className="w-12 h-[1px] bg-primary"></span>
              SPECIAL CRISIS
            </div>
            <h2 className="text-4xl font-headline font-bold text-white mb-4">Ad-Hoc: The Fluidity of Borders</h2>
